...
export interface Page {
  ...
  layout: (
    ...
    | {
        size?: ('full' | 'half' | 'oneThird' | 'twoThirds') | null;
        /**
         * Introduce el código HTML que se renderizará.
         */
        html?: string | null;
        id?: string | null;
        blockName?: string | null;
    ...
    | {
        size?: ('full' | 'half' | 'oneThird' | 'twoThirds') | null;
        language?: ('javascript' | 'html' | 'css' | 'python') | null;
        code: string;
        id?: string | null;
        blockName?: string | null;
        blockType: 'code';
...
export interface BannerBlock {
  style: 'info' | 'warning' | 'error' | 'success' | 'resumen';
  content: {
    root: {
      type: string;
      children: {
...
export interface CodeBlock {
  language?: ('typescript' | 'javascript' | 'css' | 'json' | 'plaintext' | 'markdown') | null;
  code: string;
  id?: string | null;
  blockName?: string | null;
  blockType: 'code';
